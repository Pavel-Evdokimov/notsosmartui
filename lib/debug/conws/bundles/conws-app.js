    ...
    getAttrData: function (field) {
      ...
      if ( str.length > 3) {
        ...
        if ( typeof attrData === 'undefined' && this.formView.metadataview.formViewList.length > 1 ) {
          for ( var i = 0; i < this.formView.metadataview.formViewList.length; i++ ) {
...
csui.define('conws/controls/description/description.view',['csui/lib/underscore', 'csui/lib/jquery', 'csui/lib/marionette', 'csui/utils/base',
  ...
  var DescriptionView = Marionette.ItemView.extend({
    ...
    // The TableView does not always re-render on every window resize event.
    // Thus, needs to catch the event, re-truncates the description and re-renders.
    // The timeout is optimized to avoid duplicate callbacks.
...
csui.define('conws/utils/commands/defaultactionitems',[],function () {
    ...
    return [
        ...
        {
            equals: {type: [854]},
            signature: 'Browse', // enabled related workspaces again see SAPRM-8700
            sequence: 30
        }
    ];
...
csui.define('conws/utils/workspaces/workspaces.view',['csui/lib/marionette', 'module', 'csui/lib/underscore', 'csui/lib/backbone',
  ...
  'css!conws/utils/workspaces/workspaces'
    ...
    InfiniteScrollingBehavior, NodeModelFactory, BlockingView, ModalAlert, lang, css) {
...
csui.define('conws/widgets/team/impl/dialogs/modaldialog/modal.dialog.view',[
  ...
  var ModalDialogView = Marionette.LayoutView.extend({
    ...
    className: 'cs-dialog binf-modal binf-fade',
...
csui.define('conws/widgets/team/impl/controls/rolepicker/rolepicker.view',[
  ...
  var RolePickerView = Marionette.LayoutView.extend({
    ...
    updateFocus: function(){
      // show roles
      this.searchView.currentlyFocusedElement().focus();
    }
...
csui.define('conws/widgets/team/impl/controls/filter/filter.view',[
  ...
  var FilterSearch = Marionette.ItemView.extend({
    ...
    templateHelpers: function () {
      return {
        ...
        tooltip: _.str.sformat(lang.searchPlaceholder, this.model.get('tooltip'))
      };
    },
  ...
  var FilterView = Marionette.LayoutView.extend({
    ...
    focusIcon: function(){
      // focus icon
      this.iconView.currentlyFocusedElement().focus();
    }
  });
  ...
  var RolesCellView = TemplatedCellView.extend({
        ...
        roleEditClicked: function (event) {
          ...
          var setFocus = _.bind(function(){
            ...
            this.options.tableView.$el.find('[conws-participant-row-id="'+this.model.get("id")+'"] .conws-team-table-cell-roles').click();
          },this);
  ...
  var TeamTablesView = Marionette.LayoutView.extend({
    ...
    onRender: function () {
      ...
      this.participantCollection.once('sync', function () {
        ...
        self.tabParticipantsRegion.currentView.$el.click();
      }).fetch();
  ...
  var PreviewPaneView = Marionette.LayoutView.extend({
    ...
    constructor: function PreviewPaneView(options) {
      ...
      if (this.config.roleId || this.config.metadata) {
        ...
        //---------------------------------------------------------------
        this.parent.$el.mouseenter(this, $.proxy(function () {
              if (this.config.debug === true) {
                log.info('Preview ' + this.options.node.get('id') + ': Mouseenter item') && console.log(log.last);
              }
              this.show();
            }, this)
        );

        this.parent.$el.mouseleave(this, $.proxy(function () {
              if (this.config.debug === true) {
                log.info('Preview ' + this.options.node.get('id') + ': Mouseleave item') && console.log(log.last);
              }
              this._delayedHide();
            }, this)
        );

        $pop.mouseenter(this, $.proxy(function () {
              if (this.config.debug === true) {
        ...
        $pop.mouseleave(this, $.proxy(function () {
              if (this.config.debug === true) {
...
csui.define('conws/widgets/relatedworkspaces/impl/relateditem.view',['module', 'csui/lib/underscore', 'csui/lib/marionette', 'csui/lib/jquery',
  ...
  var RelatedItemView = Marionette.ItemView.extend({
    ...
    constructor: function RelatedItemView() {
      Marionette.ItemView.prototype.constructor.apply(this, arguments);
      if (this.options && this.options.data && this.options.data.preview) {
...
var t = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<div class=\"conws-workspacestable\">\r\n  <div id=\"tableview\"></div>\r\n  <div id=\"paginationview\"></div>\r\n</div>\r\n";
}});
...
var t = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "        <img src=\""
    ...
    return "        <div class=\"conws-header-toolbar\"></div>\r\n";
},"9":function(depth0,helpers,partials,data) {
    var stack1;

  return "      <div class=\"conws-header-metadata-container\">\r\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.hasWorkspaceType : depth0),{"name":"if","hash":{},"fn":this.program(10, data, 0),"inverse":this.noop})) != null ? stack1 : "")
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.hasDescription : depth0),{"name":"if","hash":{},"fn":this.program(12, data, 0),"inverse":this.noop})) != null ? stack1 : "")
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.hasMetadataExtension : depth0),{"name":"if","hash":{},"fn":this.program(14, data, 0),"inverse":this.noop})) != null ? stack1 : "")
    + "      </div>\r\n";
},"10":function(depth0,helpers,partials,data) {
    var helper;
  ...
  return "<div class=\"conws-header-wrapper\">\r\n  <div class=\"conws-header-metadata"
    ...
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.hasToolbarView : depth0),{"name":"if","hash":{},"fn":this.program(7, data, 0),"inverse":this.noop})) != null ? stack1 : "")
    + "    </div>\r\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.hasMetadata : depth0),{"name":"if","hash":{},"fn":this.program(9, data, 0),"inverse":this.noop})) != null ? stack1 : "")
    + "  </div>\r\n\r\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.hasChildView : depth0),{"name":"if","hash":{},"fn":this.program(16, data, 0),"inverse":this.noop})) != null ? stack1 : "")
    + "</div>\r\n";
}});
...
var t = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "\r\n<div class=\"List-item\" >\r\n    <div class=\"listItemWksp wkspItem\"  id=\"wkspItem\" tabindex=\"0\">\r\n        <span class=\"wksp-expand-icon\" data-id=\""
    + this.escapeExpression(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0,{"name":"id","hash":{}}) : helper)))
...
var t = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "                <div class=\"wkspEmailFolderIcon\" data-id=\""
    + this.escapeExpression(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0,{"name":"id","hash":{}}) : helper)))
    + "\"></div>\r\n";
},"3":function(depth0,helpers,partials,data) {
    var helper;

  return "                <div class=\"wkspFolderIcon\" data-id=\""
    + this.escapeExpression(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0,{"name":"id","hash":{}}) : helper)))
    + "\"></div>\r\n";
},"5":function(depth0,helpers,partials,data) {
    var helper;

  return "                <div class=\"csui-icon compound_document listItemIcon\" data-id=\""
    + this.escapeExpression(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0,{"name":"id","hash":{}}) : helper)))
    + "\"></div>\r\n";
},"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    var stack1, helper;
  ...
  return "\r\n<div class=\"List-item\">\r\n    <div class=\"wkspItem listItemFolder\" id=\"wkspFolderItem\" data-id=\""
    ...
    + this.escapeExpression(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0,{"name":"id","hash":{}}) : helper)))
    + "\">\r\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.isEmailFolder : depth0),{"name":"if","hash":{},"fn":this.program(1, data, 0),"inverse":this.noop})) != null ? stack1 : "")
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.isRegularFolder : depth0),{"name":"if","hash":{},"fn":this.program(3, data, 0),"inverse":this.noop})) != null ? stack1 : "")
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.isCompoundDocument : depth0),{"name":"if","hash":{},"fn":this.program(5, data, 0),"inverse":this.noop})) != null ? stack1 : "")
    + "        </span>\r\n        <span data-id=\""
    + this.escapeExpression(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0,{"name":"id","hash":{}}) : helper)))
    + "\" class=\"wkspItemName\" title=\""
    + this.escapeExpression(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0,{"name":"name","hash":{}}) : helper)))
    + "\">"
    + this.escapeExpression(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0,{"name":"name","hash":{}}) : helper)))
    + "</span>\r\n        <div class=\"wkspFolder-actiondiv binf-fade\" data-id=\""
    + this.escapeExpression(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0,{"name":"id","hash":{}}) : helper)))
    + "\" style=\"display:none\">\r\n            <div id=\"folderActionBar\" class=\"wkspFolder-actionbar wkspFolder-actionbar-bubble\" >\r\n                <ul class=\"wksptile-nav wkspnav wksptile-pills\">\r\n                    \r\n                    <li class=\"needsclick\">\r\n                        <div >\r\n                            <a href=\"javascript:;\" id=\"saveEmailButton\" title=\""
...
var t = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "\r\n<div class=\"modal-dialog modal-sm load-container\">\r\n    <div class=\"binf-modal-dialog \">\r\n        <div class=\"binf-modal-content\">\r\n            <div class=\"binf-modal-header wksp-dialog-header\">\r\n                <img src=\"impl/images/headerbar_content_server.png\" title=\""
    ...
    + "</span> <input class=\"wkspInput\" id=\"userName\" tabindex=\"0\"/>\r\n                </div>\r\n                <div>\r\n                    <span>"
...
csui.define('conws/widgets/outlook/impl/utils/csservice',[
    ...
    function save(connector, folderId, emailName, attachments){
        var self = this,
    ...
    function saveEmail(connector, folderId, folderName, proposedEmailName) {
        WkspUtil.writeTrace("Ready to save the email with name: " + proposedEmailName);

        var self = this,
            emailItem = window.CurrentEmailItem;

        var nameResolver = new NameResolver({ connector: connector, folderId: folderId, originalName: proposedEmailName, centerVertically: true, folderName: folderName});
        nameResolver.validate().
            done(function (resolveResult) {
                if (resolveResult.success) {
                    WkspUtil.writeTrace("Email name validation passed.");
                    var emailName = resolveResult.name + ".eml";
                    var confirmPromise = self.confirmSaving(emailName === proposedEmailName, folderName);
                    confirmPromise.always(function (result) {
                        if (result) {
                            WkspUtil.writeTrace("Saving has been confirmed. About to save the emai with name: " + emailName);
                            ...
                            window.Office.context.mailbox.getCallbackTokenAsync(function(tokenResult) {
                                if (tokenResult.status === 'succeeded') {
                                    ...
                                    WkspUtil.writeTrace("Calling CS REST to retrieve email content and save email...");
                                    $.ajax({
                                        type: "POST",
                                        headers: {
                                            "Content-Type": undefined,
                                        ...
                                        success: function (data) {
                                            ...
                                            if (data.results != null && data.results.length > 0) {
                                                ...
                                                csRestMsg = _.str.sformat(lang.error_save_email, "OutlookAddinRestFailed");
                                            }

                                            if (successful) {
                                                ModalAlert.showSuccess(lang.info_save_successful);
                                                WkspUtil.writeTrace("Saving the email to Content Server completed.");
                                            } else {
                                                ModalAlert.showError(_.str.sformat(lang.error_save_email, csRestMsg));
                                                WkspUtil.writeTrace("Saving the email to Content Server failed with message: " + csRestMsg);
                                            }
                                        },
                                        error: function (error, errorText, obj) {
                                            WkspUtil.stopGlobalSpinner();
                                            ...
                                            if (error.status === 401) {
                                                ...
                                                ModalAlert.showError(_.str.sformat(lang.error_save_email, errMsg));
                                                WkspUtil.writeTrace("Saving the email to Content Server failed with message: " + errMsg);
                                            }
                                        }
                                    });
                                    ...
                                    // getCallbackTokenAsync unsuccessful 
                                    WkspUtil.stopGlobalSpinner();
                                    ModalAlert.showError(lang.error_retrieve_token);
                                    WkspUtil.writeTrace("Retrieving EWS access token failed.");
                                }
                            });
                        }  // closing of name validation confirmed.
                    });
                } else if (resolveResult.status === 401) {
                    self.reauthenticate(lang.warning_session_expired);
                } else {
                    WkspUtil.stopGlobalSpinner();
                    var errMsg = _.str.sformat(lang.error_validate_name, resolveResult.errorMessage);
                    WkspUtil.writeTrace(errMsg);
                    ModalAlert.showError(errMsg);
                }
            });
    }
    ...
    function getSuggestedWksps(connector, emailItem, config) {
        ...
        if (filterConfig != null && filterConfig.rules.length > 0) {
            for (i = 0; i < filterConfig.rules.length; i++) {
                ...
                if (name) {
                    processes.push(self.filterWksps(connector, rule.typeId, name, rule.weight));
                }
            }
        }
    ...
    function filterWksps(connector, wkspType, wkspName, weight) {
        var defer = $.Deferred();

        WkspUtil.writeTrace("Suggested Wksp: filter wksps with typeID'" + wkspType + "' and name contains '" + wkspName + "'");
        var queryString = 'where_workspace_type_id=' + wkspType + '&' + 'where_name=contains_' + encodeURIComponent(wkspName);
    ...
    function resolveNames(connector, folderId, emailTitleInfo, attachmentInfo){
        ...
        if (emailTitleInfo.checked){
            processes.push(self.resolveName(url, ticket, folderId, emailTitleInfo.suggestedName + ".eml", emailTitleInfo));
        }
        if (attachmentInfo != null && attachmentInfo.length ){
            for (var i = 0; i < attachmentInfo.length; i++){
                var info = attachmentInfo[i].data;
                if (info.checked){
                    processes.push(self.resolveName(url, ticket, folderId, info.suggestedName, info));
                }
            }
        }
    ...
    function resolveName(url, ticket, folderId, nameToResolve, nameInfo) {
        var self = this,
            defer = $.Deferred();

        var nameCandidates = self.prepareNames(nameToResolve);
        var verifyingPromise = self.verifyName(url, ticket, folderId, nameCandidates);
        verifyingPromise.done(function (data) {
            if (data.results && data.results.length === 0) {
                nameInfo.suggestedName = nameCandidates[0];
                nameInfo.editable = Array.isArray(nameToResolve);
                nameInfo.hasConflict = Array.isArray(nameToResolve);
                defer.resolve();
            } else if (data.results.length === nameCandidates.length) {
                var subPromise = self.resolveName(url, ticket, folderId, nameCandidates, nameInfo);
                ...
                for (var i = 0; i < nameCandidates.length; i++){
                    ...
                    if (exist){
                        ...
                        nameInfo.editable = i !== 0;
                        nameInfo.hasConflict = i !== 0;
                        break;
                    }
                }
                defer.resolve();
    ...
    function prepareNames(name){
        ...
        // Generate 5 name candidates to reduce possible multiple calls
        var candidates = [];
        for (var i = 0; i < 5; i++){
            if (i === 0 && initialRequest && !hasSequence){
                candidates.push(nameSeed + ext);
            } else {
                candidates.push(nameSeed + " (" + sequence + ")" + ext);
                sequence++;
            }
        }
...
csui.define('conws/widgets/outlook/impl/dialog/saveSection.view',[
    ...
    'css!conws/widgets/outlook/impl/conwsoutlook'         
], function ($, _, Marionette, Backbone, PageContext, WkspUtil, CSService, NameView, lang, template) {
    ...
    constructor: function saveSectionView(options) {
        ...
        self.saveStage = self.stageCode.initial; // All saving stages: initial, nameChecking, finished 
        self.saveEmail = true;
    ...
    clickNext: function(args){
        ...
        if (self.saveStage === self.stageCode.initial || self.saveStage === self.stageCode.nameChecking){
            //self.emailTitleEditable = true;
            //self.emailTitleFocus = true;
            self.collectInfo();
            ...
            if (self.nothingToSave){
                ...
                nameResolvingPromise.done(function(result){
                    ...
                    var savingEmailName = self.emailTitleInfo.checked ? self.emailTitleInfo.suggestedName : "";
                    var savingAttachments = [];
                    ...
                    for (var i = 0; i < self.attachmentInfo.length; i++){
                        ...
                        if (info.checked){
                            savingAttachments.push({name: info.suggestedName,
                                                    id: info.id,
                    ...
                    if (nameCheckingPassed) {
                        // Go to saving stage, and set the stage to "finished"
                        self.saveStage = self.stageCode.finished;
                        
                        var savePromise = CSService.save(self.connector, self.folderId, savingEmailName, savingAttachments);
...
csui.define('conws/widgets/outlook/impl/wksp/wksp.view',[
    ...
    var WkspView = Marionette.LayoutView.extend({
        ...
        saveEmail: function(event) {
            ...
            //CSService.saveEmail(connector, folderId, folderName, proposedEmailName);
            var saveRegion = new Marionette.Region({
                    el: '#savePanel'
            });
            var saveEmailView = new SaveView({
        ...
        renderToggleIcon: function () {
            ...
            //var preConfigFolder = this.model.get('preConfigFolder'),
            //    saveIcon = this.ui.$saveIcon;
            //if (preConfigFolder != null) {
            //    saveIcon.css("display", "inline-block");
            //} else {
...
var t = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "\r\n<div class=\"binf-panel-heading outlook-heading\" >"
    ...
    + "\"></span>\r\n                </td>\r\n                <td class=\"wkspSearchButton\">\r\n                    <a id=\"wkspTypeButton\" href=\"javascript:void(0);\" tabindex=\"-1\"><div class=\"wkspIcon searchTypeIcon\" title=\""
    ...
    + "\" tabindex=\"0\"/></a>\r\n                </td>\r\n                <td class=\"wkspSearchButton\">\r\n                    <a id=\"searchButton\" href=\"javascript:void(0);\" tabindex=\"-1\"><div class=\"wkspIcon searchIcon\" title=\""
...
csui.define('conws/widgets/outlook/impl/searchwksps/searchwksps.view',[
    ...
    window.wkspTypeSelected = function(wkspId, wkspName){
        ...
        if (wkspId === -100){
            ...
            $("#wkspTypeMsg").html("Workspace type: <span style='font-weight: bold'>" + wkspName + "</span>");
        }
    ...
    renderSearchForm: function (model, response, options) {
        ...
        var wkspTypeSelection = "",
            selectionFormat = "<a href=\"javascript:wkspTypeSelected({0},'{1}');\">{1}</a>";
...
var t = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "\r\n<div id=\"customSearchFormArea\">\r\n    <div class=\"binf-panel-heading outlook-heading\" >\r\n        <span class=\"headerIcon backwardIcon\" tabindex=\"0\" id=\"customSearchBack\"></span>\r\n        <span >"
    + this.escapeExpression(((helper = (helper = helpers.sectionTitle || (depth0 != null ? depth0.sectionTitle : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0,{"name":"sectionTitle","hash":{}}) : helper)))
    + "</span>\r\n    </div>    \r\n    <div class=\"wkspSearch\">\r\n\r\n        <div class=\"wkspSearchForm\" id=\"searchFormListDiv\">\r\n            <label class=\"searchFormLabel\" for=\"searchFormDW\" title=\""
...
csui.define('conws/widgets/outlook/conwsoutlook.view',[
    ...
    onBeforeShow: function (options) {
            ...
            .done(function (result) {
                ...
                if (result) {
                    ...
                    addinConfigPromise.done(function (config) {
                        //window.addinConfig = config;  //check this
        ...
        //    WkspUtil.writeTrace("Repeat output every 5s.");
        //    setTimeout(repeatWrite, 5000);
        //}
...
/* START_TEMPLATE */
csui.define('hbs!conws/widgets/configurationvolume/impl/configurationvolume',['module','hbs','csui/lib/handlebars'], function( module, hbs, Handlebars ){ 
var t = Handlebars.template({"1":function(depth0,helpers,partials,data) {
    var helper;

  return "  <div class=\"conws-empty-configurevolume-container\">"
    + this.escapeExpression(((helper = (helper = helpers.emptyResultsText || (depth0 != null ? depth0.emptyResultsText : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0,{"name":"emptyResultsText","hash":{},"data":data}) : helper)))
    + "</div>\r\n";
},"3":function(depth0,helpers,partials,data) {
    var stack1;

  return "  <div class=\"conws-configurevolume-tile-content\">\r\n"
  ...
  return "      <div\r\n          class=\"csui-configurationvolume-container csui-shortcut-region csui-region-"
  ...
  return ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.noConfiguredVolumes : depth0),{"name":"if","hash":{},"fn":this.program(1, data, 0),"inverse":this.program(3, data, 0),"data":data})) != null ? stack1 : "")
    + "\r\n";
},"useData":true});
Handlebars.registerPartial('conws_widgets_configurationvolume_impl_configurationvolume', t);
return t;
});
/* END_TEMPLATE */
;
  ...
  var ConfigurationVolumeView = ShortcutsView.extend({
    ...
    onRender: function () {
      ...
      if (self.model.fetched && self.fitItemsInWidget) {
        //appending the class which will make the configuration volumes items
        //to have the same length, regardless of its content to fit in whole widget.
