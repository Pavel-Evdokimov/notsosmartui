  ...
  var toolbarItems = {
    ...
    inlineToolbar: new ToolItemsFactory({
        ...
        other: [
          ...
          {
            signature: "Collect", name: lang.ToolbarCollect,
            /* TODO: need to replace this temp icon once UX provides actual svg icon */
            icon: "icon-toolbar-collect binf-glyphicon binf-glyphicon-shopping-cart"
          }
        ]
      },
      {
...
csui.define('csui/widgets/search.results/impl/metadata/search.metadata.view',[
  ...
  'css!csui/widgets/search.results/impl/search.results'
], function (_, Marionette, base, date, lang, itemTemplate) {
  "use strict";
  ...
  var SearchMetadataItemView = Marionette.ItemView.extend({
    ...
    templateHelpers: function () {
      var displayCount = 0,
          desc         = this.options.searchItemModel.get("description"),
          summary      = this.options.searchItemModel.get("summary");
      if ((summary && summary.length) || (desc && desc.length)) {
        displayCount = 3;
      } else {
        displayCount = 2;
      }
    ...
    _updateToolItems: function () {
      if (this.toolbarView) {
        ...
        _.each(selectedModelIds, function (id) {
          var updatedNode = this.collection.findWhere({id: id});
          !!updatedNode && nodes.push(updatedNode);
        }, this);
