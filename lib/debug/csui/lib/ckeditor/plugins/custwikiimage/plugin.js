 ...
 */
 (function() {
    ...
    function c(b) {
        var c = b.editor
            , d = c.config.custwikiimage_maximumDimensions
            , e = b.data.image;
        d.width && e.width > d.width ? (a(c, c.lang.custwikiimage.imageTooWide),
            b.cancel()) : d.height && e.height > d.height && (a(c, c.lang.custwikiimage.imageTooTall),
            b.cancel())
    }
    function e(a) {
        var b = "span.custwikiimageTmpWrapper\x3espan { top: 50%; margin-top: -0.5em; width: 100%; text-align: center; color: #fff; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5); font-size: 50px; font-family: Calibri,Arial,Sans-serif; pointer-events: none; position: absolute; display: inline-block;}";
        a.custwikiimage_hideImageProgress && (b = "span.custwikiimageTmpWrapper { color:#333; background-color:#fff; padding:4px; border:1px solid #EEE;}");
        return ".custwikiimageOverEditor { " + (a.custwikiimage_editorover || "box-shadow: 0 0 10px 1px #999999 inset !important;") + " }a.custwikiimageTmpWrapper { color:#333; background-color:#fff; padding:4px; border:1px solid #EEE;}.custwikiimageTmpWrapper { display: inline-block; position: relative; pointer-events: none;}" + b + ".uploadRect {display: inline-block;height: 0.9em;vertical-align: middle;width: 20px;}.uploadRect span {background-color: #999;display: inline-block;height: 100%;vertical-align: top;}.custwikiimageTmpWrapper .uploadCancel { background-color: #333333;border-radius: 0.5em;color: #FFFFFF;cursor: pointer !important;display: inline-block;height: 1em;line-height: 0.8em;margin-left: 4px;padding-left: 0.18em;pointer-events: auto;position: relative; text-decoration:none; top: -2px;width: 0.7em;}.custwikiimageTmpWrapper span .uploadCancel { width:1em; padding-left:0}"
    }
    function f(a, b, c, d) {
        var wikiBody;
        H = !b;
           ...
           /* E.multiple = "multiple",*/
            ...
            E.addEventListener("change", function() {
                ...
                if (a) {
                    ...
                    for (var b = 0; b < a; b++) {
                        var c = E.files[b]
                            , d = CKEDITOR.tools.extend({}, E.custwikiimageData);
                        d.file = c;
                        d.name = c.name;
                        d.originalName = d.name;
                        d.id = CKEDITOR.plugins.custwikiimage.getTimeStampId();
                        d.forceLink = H;
                        d.mode = {
                            type: "selectedFile",
                            i: b,
                        ...
                        CKEDITOR.plugins.custwikiimage.insertSelectedFile(C, d)
                    }
                }
            }));
        E.accept = b ? ".jpg, .png, .jpeg, .gif, .bmp|images/*" : "";
        E.value = "";
        E.custwikiimageData = {
            context: c,
            callback: d,
    ...
    function b(a, b, c, d, e) {
        ...
        if ("span" == d.$.nodeName.toLowerCase()) {
            ...
            /\.svg$/.test(b.name) && (f.removeAllListeners(),
                f.replace(d),
                c.fire("custwikiimage.finishedUpload", {
                    name: name,
                    element: f
                }),
    ...
    function h(b) {
        var c = b.listenerData
            ...
            , c = c.element;
        b.removeListener();
        a(d, d.lang.custwikiimage.badUrl + ': "' + b.sender.data("cke-saved-src") + '"');
        c.remove()
    }
    function n(a, b, c, d,f) {
        0 === a.$.naturalWidth ? window.setTimeout(function() {
            ...
            b.fire("custwikiimage.finishedUpload", {
                name: d,
                element: a
            }),
    ...
    function r(c, d) {
        var e = CKEDITOR.plugins.custwikiimage.isImageExtension(c, d.name)
            , f = "href"
            , g = !1;
        !d.forceLink && e && (f = "src",
            g = !0);
        ...
        if (d.requiresImage && !e)
            return a(c, c.lang.custwikiimage.nonImageExtension),
                null ;
        if ("boolean" == typeof c.fire("custwikiimage.startUpload", d) || !d.url)
            return null ;
        if ("base64" == d.url) {
        ...
        k.onload = function() {
            ...
            if ("boolean" != typeof c.fire("custwikiimage.serverResponse", e)) {
                if ("undefined" == typeof e.url) {
                    ...
                    h = e.url,
                        l = "";
                c.fire("custwikiimage.endUpload", {
                    name: d.name,
                    ok: !!h,
                    xhr: k,
                    data: d
                ...
                var t = false;
                200 != k.status && (413 == k.status ? a(c, c.lang.custwikiimage.fileTooBig) : (u = c.lang.custwikiimage["httpStatus" + k.status],
                u || (u = c.lang.custwikiimage.errorPostFile,
                    u += " " + k.status),
        ...
        k.onerror = function(b) {
            a(c, c.lang.custwikiimage.xhrError.replace("%0", d.url));
    ...
    function v(a, b) {
        if (!b.callback) {
            var c = CKEDITOR.plugins.custwikiimage.isImageExtension(a, b.name)
                , e = !a.config.custwikiimage_hideImageProgress;
            !b.forceLink && c && e ? c = t(b.file, b.id, a) : (c = c && !b.forceLink ? new CKEDITOR.dom.element("span",a.document) : new CKEDITOR.dom.element("a",a.document),
                ...
                c.setAttribute("class", "custwikiimageTmpWrapper"),
        ...
        e = b.inputName || a.config.custwikiimage_inputname || "upload";
        e = "file";
    ...
    function z(a, b, c) {
        if (a.document && a.document.$) {
            ...
            if (c) {
                ...
                a = a.lang.custwikiimage.processing,
                    d = "100%";
    ...
    function t(a, b, c) {
        ...
        d.setAttribute("id", b);
        d.setAttribute("class", "custwikiimageTmpWrapper");
    ...
    function p(a, b, c, e) {
        if ("file" != e.type) {
            ...
            if ("QuickUpload" == g.action)
                c.hasQuickUpload = !0,
                    c.onFileSelect = null ,
                a.config.custwikiimage_respectDialogUploads || (e.label = h ? a.lang.custwikiimage.addImageDialog : a.lang.custwikiimage.addFile,
    ...
    function q(a, b) {
        var c = b.listenerData.editor
            ...
            , e = CKEDITOR.plugins.custwikiimage.getTimeStampId();
        CKEDITOR.plugins.custwikiimage.insertPastedFile(c, {
            context: b.data.$,
            name: a.name || e + ".png",
            file: a,
            forceLink: !1,
    ...
    var B = {
        elements: {
            $: function(a) {
                a = a.attributes;
                if ("custwikiimageTmpWrapper" == (a && a["class"]))
                    return !1
            }
        }
    }, E, C, H, J = window.URL || window.webkitURL;

    CKEDITOR.plugins.add("custwikiimage", {
        ...
        onLoad: function() {
            ...
            var b = ".custwikiimageOverContainer {" + (CKEDITOR.config.custwikiimage_containerover || "box-shadow: 0 0 10px 1px #99DD99 !important;") + "} .custwikiimageOverDialog {" + (CKEDITOR.config.custwikiimage_dialogover || "box-shadow: 0 0 10px 4px #999999 inset !important;") + "} .custwikiimageOverCover {" + (CKEDITOR.config.custwikiimage_coverover || "box-shadow: 0 0 10px 4px #99DD99 !important;") + "} "
        ...
        init: function(b) {
            ...
            if ("undefined" != typeof FormData)
                if (("undefined" == typeof d.custwikiimage_imageExtensions && (d.custwikiimage_imageExtensions = "jpe?g|gif|png") && d.addimage.url()) ||
                    ...
                    window.console && console.log && (console.log('The editor is missing the required permission hence disabling image plugin'),
                        console[console.warn ? "warn" : "log"]('The "custwikiimage" plugin now is disabled.'));
                else if ("base64" != d.addimage.url() || "undefined" != typeof FormData) {
                    b.addFeature({
                        allowedContent: "img[!src,width,height];a[!href];span[id](custwikiimageTmpWrapper);"
                    });
                    ...
                    ;
                    b.on("custwikiimage.startUpload", function(b) {
                        var c = b.editor
                            , d = c.config
                            , e = b.data && b.data.file;
                        d.custwikiimage_maxFileSize && e && e.size && e.size > d.custwikiimage_maxFileSize ? (a(c, c.lang.custwikiimage.fileTooBig),
                            b.cancel()) : (e = b.data.name,
                            d.custwikiimage_invalidExtensions && (new RegExp(".(?:" + d.custwikiimage_invalidExtensions + ")$","i")).test(e) ? (a(c, c.lang.custwikiimage.invalidExtension),
                                b.cancel()) : d.custwikiimage_acceptedExtensions && !(new RegExp(".(?:" + d.custwikiimage_acceptedExtensions + ")$","i")).test(e) ? (d = c.lang.custwikiimage.nonAcceptedExtension.replace("%0", d.custwikiimage_acceptedExtensions),
                                a(c, d),
                                b.cancel()) : CKEDITOR.tools.getCsrfToken && (c = b.data.extraFields || {},
                                c.ckCsrfToken = CKEDITOR.tools.getCsrfToken(),
                                b.data.extraFields = c))
                    });
                    b.on("custwikiimage.startUpload", function(a) {
                        var b = a.data
                            , c = a.editor;
                        if (!b.image && !b.forceLink && CKEDITOR.plugins.custwikiimage.isImageExtension(c, b.name) && b.mode && b.mode.type && c.hasListeners("custwikiimage.localImageReady")) {
                            a.cancel();
                            "base64paste" == b.mode.type && (a = CKEDITOR.plugins.custwikiimage.getTimeStampId(),
                                b.result = '\x3cspan id\x3d"' + a + '" class\x3d"custwikiimageTmpWrapper" style\x3d"display:none"\x3e\x26nbsp;\x3c/span\x3e',
                                b.mode.id = a);
                            var d = new Image;
                            d.onload = function() {
                                var a = CKEDITOR.tools.extend({}, b);
                                a.image = d;
                                "boolean" != typeof c.fire("custwikiimage.localImageReady", a) && CKEDITOR.plugins.custwikiimage.insertProcessedFile(c, a)
                            }
                            ;
                            d.src = "string" == typeof b.file ? b.file : J.createObjectURL(b.file)
                        }
                    });
                    if (d.custwikiimage_convertBmp)
                        b.on("custwikiimage.localImageReady", g);
                    if (d.custwikiimage_maximumDimensions)
                        b.on("custwikiimage.localImageReady", c);
                    b.on("custwikiimage.finishedUpload", function(a) {
                    ...
                    b.on("paste", function(c) {
                        ...
                        if (d = d.html || d.type && "html" == d.type && d.dataValue)
                            CKEDITOR.env.webkit && 0 < d.indexOf("webkit-fake-url") && (a(b, b.lang.custwikiimage.uselessSafari),
                    ...
                    var d = function(a) {
                        "wysiwyg" == b.mode && b.editable().$.querySelector(".custwikiimageTmpWrapper") && (a = a.name.substr(5).toLowerCase(),
                    ...
                    b.ui.addButton("addImage", {
                        label: b.lang.custwikiimage.addImage,
                        command: "addImage",
                        toolbar: "insert",
                        allowedContent: "img[!src,width,height];span[id](custwikiimageTmpWrapper);",
                        requiredContent: "img[src]"

                    });
                    var h, l, m, n = -1, p, q, r, t = -1, w, x, z, B = function() {
                        var a = CKEDITOR.dialog.getCurrent();
                        a ? a.parts.title.getParent().removeClass("custwikiimageOverCover") : b.container.removeClass("custwikiimageOverContainer")
                    };
                    b.on("destroy", function() {
                        CKEDITOR.removeListener("custwikiimage.droppedFile", B);
                    ...
                    CKEDITOR.on("custwikiimage.droppedFile", B);
                    var E = function(a) {
                        if (-1 == t && k(a)) {
                            if (a = CKEDITOR.dialog.getCurrent()) {
                                if (!a.handleFileDrop)
                                    return;
                                a.parts.title.getParent().addClass("custwikiimageOverCover")
                            } else
                                b.readOnly || b.container.addClass("custwikiimageOverContainer");
                            w = t = 0;
                    ...
                    CKEDITOR.document.on("dragover", function(a) {
                        if (!b.config.custwikiimage_allowDropOutside && k(a) && "copy" != a.data.$.dataTransfer.dropEffect)
                            return a.data.$.dataTransfer.dropEffect = "none",
                                a.data.preventDefault(),
                                !1
                    });
                    var W = function(a) {
                        l.removeClass("custwikiimageOverEditor");
                        n = -1;
                        CKEDITOR.fire("custwikiimage.droppedFile");
                        t = -1;
                        if (b.readOnly)
                        ...
                        if (d && d.files && 0 < d.files.length) {
                            ...
                            for (e = 0; e < d.files.length; e++) {
                                ...
                                CKEDITOR.plugins.custwikiimage.insertDroppedFile(b, {
                                    context: c,
                                    name: g.name,
                                    file: g,
                        ...
                        , S = function(a) {
                        -1 == n && k(a) && (b.readOnly || l.addClass("custwikiimageOverEditor"),
                        ...
                        , X = function(a) {
                        -1 != n && (a = a.data.$,
                        a.clientX <= n || a.clientY <= p || a.clientX >= q || a.clientY >= r) && (l.removeClass("custwikiimageOverEditor"),
                            n = -1)
                    }
                        , Y = function(a) {
                        if (-1 != n) {
                    ...
                    b.plugins.fileDropHandler = {
                        addTarget: function(a, c) {
                            a.on("dragenter", function(b) {
                                -1 == n && k(b) && (a.addClass("custwikiimageOverDialog"),
                            ...
                            a.on("dragleave", function(b) {
                                -1 != n && (b = b.data.$,
                                b.clientX <= n || b.clientY <= p || b.clientX >= q || b.clientY >= r) && (a.removeClass("custwikiimageOverDialog"),
                                    n = -1)
                            });
                            ...
                            a.on("drop", function(d) {
                                a.removeClass("custwikiimageOverDialog");
                                n = -1;
                                CKEDITOR.fire("custwikiimage.droppedFile");
                                t = -1;
                                var e = d.data.$
                                ...
                                if (f && f.files && 0 < f.files.length) {
                                    ...
                                    for (var g = 0; g < d; g++) {
                                        ...
                                        CKEDITOR.plugins.custwikiimage.processFileWithCallback(b, h)
                                    }
                                }
                            })
                        }
    ...
    "undefined" != typeof FormData && (CKEDITOR.plugins.custwikiimage = {
        ...
        isImageExtension: function(a, b) {
            return a.config.custwikiimage_imageExtensions ? (new RegExp(".(?:" + a.config.custwikiimage_imageExtensions + ")$","i")).test(b) : !1
        },
        ...
        CKEDITOR.on("dialogDefinition", function(a) {
            if (a.editor.plugins.custwikiimage) {
