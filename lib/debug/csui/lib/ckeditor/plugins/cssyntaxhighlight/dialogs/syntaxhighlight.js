...
*/
CKEDITOR.dialog.add( 'cssyntaxhighlightDialog', function( editor ) {
	csui.require([ 'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shCore',
	'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushAppleScript',
		  'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushAS3',
		  'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushBash',
		  'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushColdFusion',
		  'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushCpp',
		  'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushCSharp',
		  'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushCss',
		  'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushDelphi',
		  'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushDiff',
		  'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushErlang',
		  'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushGroovy',
		  'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushJava',
		  'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushJavaFX',
		  'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushJScript',
		  'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushPerl',
		  'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushPhp',
		  'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushPlain',
		  'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushPowerShell',
		  'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushPython',
		  'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushRuby',
		  'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushSass',
		  'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushScala',
		  'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushSql',
		  'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushVb',
		  'csui/lib/ckeditor/plugins/cssyntaxhighlight/scripts/shBrushXml'
	  ],function() {
		  return;
	  });
	...
	var getDefaultOptions=function() {
		...
		options.hideGutter=String(editor.config.cs_syntaxhighlight_hideGutter).toLowerCase()==='true';
		options.hideControls=String(editor.config.cs_syntaxhighlight_hideControls).toLowerCase()==='true';
		options.collapse=String(editor.config.cs_syntaxhighlight_collapse).toLowerCase()==='true';
		options.codeTitle=editor.config.cs_syntaxhighlight_codeTitle;
		options.showColumns=String(editor.config.cs_syntaxhighlight_showColumns).toLowerCase()==='true';
		options.noWrap=String(editor.config.cs_syntaxhighlight_noWrap).toLowerCase()==='true';
		options.firstLine=editor.config.cs_syntaxhighlight_firstLine;
		options.highlightChecked=String(editor.config.cs_syntaxhighlight_highlightChecked).toLowerCase()==='true';
		options.highlight=editor.config.cs_syntaxhighlight_highlight;
		options.lang=(validLangs.indexOf(editor.config.cs_syntaxhighlight_lang)>-1) ? editor.config.cs_syntaxhighlight_lang : 'as3';
		options.code=editor.config.cs_syntaxhighlight_code;
		return options
	};
	...
	return {
		title : editor.lang.cssyntaxhighlight.title,
		minWidth : 500,
		minHeight : 400,
		contents : [
			{
				id : 'source',
				label : editor.lang.cssyntaxhighlight.sourceTab,
				accessKey : 'S',
				elements : [
					{
						type : 'vbox',
						children : [
							{
								...
								label : editor.lang.cssyntaxhighlight.langLbl,
								widths : ['25%','75%'],
								items : [
									['ActionScript3','as3'],
					...
					},
					{
						...
						rows : 22,
						style : 'width:100%',
						validate: CKEDITOR.dialog.validate.notEmpty( editor.lang.cssyntaxhighlight.sourceTextareaEmptyError ),
						setup : function(data) {
							if(data.code) {
			...
			{
				id : 'cssyntaxhighlightadvanced',
				label : editor.lang.cssyntaxhighlight.advancedTab,
				accessKey : 'A',
				elements : [
					{
						type : 'vbox',
						children : [
							{
								type : 'html',
								html : '<strong>'+editor.lang.cssyntaxhighlight.hideGutter+'</strong>'
							},
							{
								type : 'checkbox',
								id : 'hide_gutter',
								label : editor.lang.cssyntaxhighlight.hideGutterLbl,
								setup : function(data) {
							...
							{
								type : 'html',
								html : '<strong>'+editor.lang.cssyntaxhighlight.hideControls+'</strong>'
							},
							{
								type : 'checkbox',
								id : 'hide_controls',
								label : editor.lang.cssyntaxhighlight.hideControlsLbl,
								setup : function(data) {
							...
							{
								type : 'html',
								html : '<strong>'+editor.lang.cssyntaxhighlight.collapse+'</strong>'
							},
							{
								type : 'checkbox',
								id : 'collapse',
								label : editor.lang.cssyntaxhighlight.collapseLbl,
								setup : function(data) {
							...
							{
								type : 'html',
								html : '<strong>'+editor.lang.cssyntaxhighlight.codeTitleLbl+'</strong>'
							},
							{
								type : 'hbox',
								widths : ['5%','95%'],
							...
							{
								type : 'html',
								html : '<strong>'+editor.lang.cssyntaxhighlight.showColumns+'</strong>'
							},
							{
								type : 'checkbox',
								id : 'show_columns',
								label : editor.lang.cssyntaxhighlight.showColumnsLbl,
								setup : function(data) {
							...
							{
								type : 'html',
								html : '<strong>'+editor.lang.cssyntaxhighlight.lineWrap+'</strong>'
							},
							{
								type : 'checkbox',
								id : 'line_wrap',
								label : editor.lang.cssyntaxhighlight.lineWrapLbl,
								setup : function(data) {
							...
							{
								type : 'html',
								html : '<strong>'+editor.lang.cssyntaxhighlight.lineCount+'</strong>'
							},
							{
								type : 'hbox',
								widths : ['5%','95%'],
							...
							{
								type : 'html',
								html : '<strong>'+editor.lang.cssyntaxhighlight.highlight+'</strong>'
							},
							{
								type : 'hbox',
								widths : ['5%','95%'],
							...
							},
							{
								...
								children : [
									{
										type : 'html',
										html : '<i>'+editor.lang.cssyntaxhighlight.highlightLbl+'</i>'
									}
								]
							}
						]
		...
		onOk : function() {
			...
			SyntaxHighlighter.defaults["class-name"] = editor.config.syntaxhighlighter_className;
