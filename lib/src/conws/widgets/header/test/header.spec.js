    ...
    describe('view renders', function () {
      ...
      it('... correctly without configuration..', function (done) {
        ...
        TestUtil.run(done, function () {
          ...
          expect(view.$('div .conws-header-desc .conws-description').length).toBe(1);
          expect(view.$('div .conws-header-desc .conws-description').html()).toBe('');
          ...
          expect(view.$('.conws-header-wrapper .conws-header-toolbar #Comment').length).toBe(1);
          expect(view.$(
              '.conws-header-wrapper .conws-header-toolbar .csui-rightToolbar li#Favorite2').length).toBe(
              1);
          expect(view.$(
              '.conws-header-wrapper .conws-header-toolbar .csui-rightToolbar li#Favorite2 .icon-socialFavOpen').length).toBe(
              1);
          expect(view.$(
              '.conws-header-wrapper .conws-header-toolbar .csui-rightToolbar li#Favorite2 .icon-socialFav').length).toBe(
              0);
        });
      });
      ...
      it('... comment and favorite icons are not shown based on the options', function (done) {
        ...
        TestManager.fetch(done, view, view.model.get('id'));
        TestUtil.run(done, function () {
          expect(view.$('div .conws-header-toolbar #Comment').length).toBe(0);
          expect(view.$('div .conws-header-toolbar .csui-rightToolbar li#Favorite2').length).toBe(
              0);
          expect(view.$(
              'div .conws-header-toolbar .csui-rightToolbar li#Favorite2 .icon-socialFavOpen').length).toBe(
              0);
          expect(view.$(
              'div .conws-header-toolbar .csui-rightToolbar li#Favorite2 .icon-socialFav').length).toBe(
              0);
        });
      });
      ...
      it('... comment icon is not shown and favorite icon is shown based on the options',
        function (done) {
          ...
          TestUtil.run(done, function () {
            expect(view.$('div .conws-header-toolbar #Comment').length).toBe(0);
            expect(
                view.$('div .conws-header-toolbar .csui-rightToolbar li#Favorite2').length).toBe(
                1);
          });
        });
      ...
      it('... workspace type,description, activity feed,toolbar not shown based on the options',
        function (done) {
          ...
          TestUtil.run(done, function () {
            ...
            expect(view.$('div #conws-header-childview').length).toBe(0);
            expect(view.$('div .conws-header-toolbar .csui-rightToolbar').length).toBe(0);
      ...
      it('... correctly as configured with child widget', function (done) {
        ...
        TestUtil.run(done,function () {
          ...
          expect(view.$('div .conws-header-toolbar #Comment').length).toBe(1);
          expect(view.$('div .conws-header-toolbar .csui-rightToolbar li#Favorite2').length).toBe(1);
          expect(view.$('div .conws-header-toolbar .csui-rightToolbar li#Favorite2 .icon-socialFavOpen').length).toBe(
              1);
          expect(view.$('div .conws-header-toolbar .csui-rightToolbar li#Favorite2 .icon-socialFav').length).toBe(0);
        });
      });
      ...
      it('... correctly as configured with favorite set', function (done) {
        ...
        TestUtil.run(done,function () {
          ...
          expect(view.$('div #conws-header-childview').length).toBe(1);
          expect(view.$('div .conws-header-toolbar .csui-rightToolbar #Comment').length).toBe(1);
          expect(view.$('div .conws-header-toolbar .csui-rightToolbar li#Favorite2').length).toBe(1);
          expect(view.$('div .conws-header-toolbar .csui-rightToolbar li#Favorite2 .icon-socialFavOpen').length).toBe(
              0);
          expect(view.$('div .conws-header-toolbar .csui-rightToolbar li#Favorite2 .icon-socialFav').length).toBe(1);
        });
      });
      ...
      it('... correctly remove favorite via onclick', function (done) {
        ...
        TestUtil.run(done,function () {
          ...
          expect(view.$('div .conws-header-toolbar .csui-rightToolbar li#Favorite2 .icon-socialFavOpen').length).toBe(
              0);
          expect(view.$('div .conws-header-toolbar .csui-rightToolbar li#Favorite2 .icon-socialFav').length).toBe(1);
          view.$('button > span.icon-socialFav').click();
          TestUtil.waitFor(done,function () {
            return (view.$('div .conws-header-toolbar .csui-rightToolbar li#Favorite2 .icon-socialFavOpen').length === 1);
            ...
            function (done) {
              ...
              TestUtil.run(done,function () {
                ...
                expect(view.$('div .conws-header-desc .conws-description > span').html()).toBe(
                    'Bosch PTA 1000. The flexible PTA 1000. Perfect support when sawing large workpieces');
                expect(view.$('div #conws-header-childview').length).toBe(0);
                expect(view.$('.conws-header-toolbar .csui-rightToolbar li#Comment .conws-comment-icon').length).toBe(1);
              });
            });
