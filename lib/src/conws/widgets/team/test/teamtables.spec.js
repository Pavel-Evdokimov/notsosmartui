...
define([
  ...
  describe('TeamView Expanded View', function () {
    ...
    describe('view renders', function () {
      ...
      it('a team with just one empty role.', function (done) {
      ...
      it('a team with two roles, one with one and one with two members.', function (done) {
        TestManager.createRoles([
          {id: 101, name: 'Staff', leader: true},
        ...
        TestUtil.run(done,function () {
          ...
          var members = view.$('#participantsview tbody > tr', dataTable);
          expect(view.$('.conws-roles-btn', members).length).toEqual(2);
          var emails = view.$('td.csui-table-cell-conws_participantemail', members);
