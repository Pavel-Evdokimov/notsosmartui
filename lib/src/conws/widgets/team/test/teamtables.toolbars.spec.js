  ...
  describe('TeamView Expanded View', function () {
    ...
    describe('Participants team tables toolbar and commands', function () {
      ...
      describe('Toolbar', function () {
        ...
        it('is rendered correctly when a single participant is selected', function (done) {
          TestManager.createRolesWithActions([
            {props: {id: 101, name: 'Staff', leader: true}, actions: {'edit-role': {}}}
          ]);
        ...
        it('is rendered correctly when multiple participants are selected', function (done) {
          TestManager.createRolesWithActions([
            {props: {id: 101, name: 'Staff', leader: true}, actions: {'edit-role': {}}}
          ]);
          TestManager.createMembers([
        ...
        it('is rendered correctly when permissions are insufficient', function (done) {
          TestManager.createRolesWithActions([
    ...
    describe('Roles team tables toolbar and commands', function () {
      ...
      describe('Toolbar', function () {
        ...
        it('is rendered correctly when a single role is selected', function (done) {
          TestManager.createRolesWithActions([
        ...
        it('is rendered correctly when multiple roles are selected', function (done) {
          TestManager.createRolesWithActions([
        ...
        it('is rendered correctly when multiple roles are selected containing the leader role',
            function (done) {
              TestManager.createRolesWithActions([
