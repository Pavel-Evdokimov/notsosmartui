...
define(['csui/lib/jquery', 'csui/lib/underscore',
  ...
  'conws/utils/commands/test/addconws.show.link.mock.data',
  ...
  describe('Create workspace with message link: test', function () {
    ...
    function createDialog(done,testInfo,templateid) {
      ...
      TestUtil.run(done,function () {
        ...
        if (templateid===29725) {
          ...
          testInfo.htmlReferenceTabPanel = $(testInfo.htmlCreateForm).find(".cs-metadata-properties #conws-reference");
        }
      });
    }
    ...
    describe("Create workspace with message link: verify that save succeeds", function () {
      ...
      it("workspace can be saved", function (done) {
