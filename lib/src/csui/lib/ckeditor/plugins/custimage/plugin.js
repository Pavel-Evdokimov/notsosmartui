...
CKEDITOR.plugins.add("custimage", {
    ...
    beforeInit:function(b){
        b.addContentsCss && b.addContentsCss(this.path +"styles/custimage.css");

    },
    init: function (b) {
        b.addContentsCss && b.addContentsCss(this.path +"styles/custimage.css");
        if (!b.plugins.image2) {
            CKEDITOR.dialog.add("custimage", this.path + "dialogs/custimage.js");
            ...
            b.addCommand("custimage", new CKEDITOR.dialogCommand("custimage", {
                allowedContent: a,
            ...
            b.ui.addButton && b.ui.addButton("custimage", {
            ...
            b.on("doubleclick", function (b) {
                var a =
                    b.data.element;
                !a.is("img") || a.data("cke-realelement") || a.isReadOnly() || (b.data.dialog = "custimage")
            });
