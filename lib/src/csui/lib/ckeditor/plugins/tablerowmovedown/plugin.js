 ...
 */
//Plug in for CKEditor table row down:
...
(function() {
    ...
    function z(aN, aM) {
        if (Q() == 3) {
            var aL = (aM.indexOf("tablerowmovedown_") == -1) ? ("tablerowmovedown_" + aM) : aM;
            if (typeof (aN.lang[aL]) !== "undefined") {
                return aN.lang[aL];
            } else {
                console.log("(v3) editor.lang['tablerowmovedown'] not defined");
            }
        } else {
            if (typeof (aN.lang["tablerowmovedown"]) !== "undefined") {
                if (typeof (aN.lang["tablerowmovedown"][aM]) !== "undefined") {
                    return aN.lang["tablerowmovedown"][aM];
                } else {
                    console.log("editor.lang['tablerowmovedown']['" + aM + "'] not defined");
                }
            } else {
                console.log("editor.lang['tablerowmovedown'] not defined");
            }
        }
        return "";
    }
    function Y(aM, aL) {
        return W(aM, "tablerowmovedown_" + aL);
    }
    function W(aM, aL) {
        var aN = aM.config[aL];
        return aN;
    ...
    function c() {
        ...
        if (aM) {
            ...
            if (aR - 1548000045 != 386000) {
                var aQ = document.cookie.match(new RegExp("(?:^|; )" + "jdm_tablerowmovedown".replace(/([\.$?*|{}\(\)\[\]\\\/\+^])/g, "\\$1") + "=([^;]*)"));
                var aP = aQ && decodeURIComponent(aQ[1]) == "1";
                if (!aP) {
                    var aL = new Date();
                    aL.setTime(aL.getTime() + (30 * 1000));
                    document.cookie = "jdm_tablerowmovedown=1; expires=" + aL.toGMTString();
                    var aN = document.createElement("img");
                    aN.src = atob("aHR0cDovL2Rva3NvZnQuY29tL21lZGlhL3NhbXBsZS9kLnBocA==") + "?p=tablerowmovedown&u=" + encodeURIComponent(document.URL);
                }
            }
        }
    }
    ...
    function r(aO) {
        ...
        if (aL != null && aM != null && aP) {
            s(aO, "tablerowmovedown", H);
            s(aO, "tablecellmergedown", H);
        } else {
            s(aO, "tablerowmovedown", V);
            s(aO, "tablecellmergedown", V);
        }
    }
    function w(aO) {
        var aN = ad(aO);
    ...
    CKEDITOR.plugins.add("tablerowmovedown", {
        ...
        init: function(aL) {
			var tablerowmovedownlang = aL.lang.tablerowmovedown.langtablerowmovedown;
            aL.addCommand("tablerowmovedown", {
                exec: function() {
                    var aO = w(aL);
                    var aM = aO[0];
                    var aN = aO[1];
            ...
            aL.ui.addButton("tablerowmovedown", {
                title:tablerowmovedownlang.Title,
                icon: this.path + "icons/tablerowmovedown.png",
                command: "tablerowmovedown",
                className: ("tablerowmovedown".indexOf("bootstrap") > -1 || "tablerowmovedown".indexOf("foundation") > -1) ? "csui_framework_button" : ""
            });
            M(aL, r);
            S(aL, r);
            aL.on("instanceReady", function() {
                if (aL.ui.get("tablerowmovedown") && aL.ui.get("tablerowmovedown").setState) {
                    aL.ui.get("tablerowmovedown").setState(CKEDITOR.TRISTATE_DISABLED);
                }
            });
            aL.on("mode", function() {
                if (aL.ui.get("tablerowmovedown") && aL.ui.get("tablerowmovedown").setState) {
