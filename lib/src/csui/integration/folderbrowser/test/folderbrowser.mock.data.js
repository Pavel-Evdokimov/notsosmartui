...
define([
  'csui/lib/jquery', 'csui/lib/jquery.mockjax',
  'csui/lib/underscore', 'json!./result.json'
  ...
  DataManager.test = {
    enable: function () {
      ...
      test1Mocks.push(mockjax({
        url: new RegExp('^//server/otcs/cs/api/v2/nodes/101/nodes(?:\\?(.*))?$'),
        responseTime: 50,
        responseText: DataManager.nodesData(1, 20, 1, 101)
      }));

      test1Mocks.push(mockjax({
        url: new RegExp('//server/otcs/cs/api/v2/nodes/103(?:\\?(.*))?$'),
        responseTime: 50,
        responseText: DataManager.nodeData(103, 1)
      }));

      test1Mocks.push(mockjax({
        url: '//server/otcs/cs/api/v1/nodes/103/ancestors', responseTime: 50,
        responseText: {
          "ancestors": [{
            "volume_id": -2000,
            "id": 2000,
      ...
      test1Mocks.push(mockjax({
        url: new RegExp('^//server/otcs/cs/api/v2/nodes/103/nodes(?:\\?(.*))?$'),
        responseTime: 50,
        responseText: DataManager.nodesData(1, 20, 1, 103)
      }));

      test1Mocks.push(mockjax({
        url: new RegExp('^//server/otcs/cs/api/v1/nodes/103/addablenodetypes(?:\\?(.*))?$'),
        urlParams: ['query'],
        responseText: {
          data: {},
          definitions: {}
      ...
      test1Mocks.push(mockjax({
        url: '//server/otcs/cs/api/v1/nodes/103/facets',
        responseText: {
          facets: {}
        }
      }));
      ...
      test1Mocks.push(mockjax({
        url: new RegExp('^//server/otcs/cs/api/v1/nodes/103/facets(?:\\?(.*))?$'),
        urlParams: ['query'],
        responseText: {
          facets: {}
        }
  ...
  DataManager.nodeData = function (id, size) {
    var responseText = _.deepClone(nodeResults);
