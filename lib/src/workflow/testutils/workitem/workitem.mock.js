...
define([
...
], function (mockjax, assignmentResults) {
  'use strict';
  ...
  return {
    ...
    enable: function () {
      ...
      mocks.push(mockjax({
        url: '//server/otcs/cs/api/v2/nodes/4711/nodes?fields=properties&fields=versions%7Bowner_id%7D.element(0)&expand=properties%7Bnode%7D&limit=30&page=1',
        responseText: {
          "collection": {
            "paging": {
              "limit": 30,
      ...
      mocks.push(mockjax({
        url: '//server/otcs/cs/api/v2/nodes/1704/nodes?fields=properties&fields=versions%7Bowner_id%7D.element(0)&expand=properties%7Bnode%7D&limit=30&page=1',
        responseText: {
          "collection": {
            "paging": {
              "limit": 30,
      ...
      mocks.push(mockjax({
        url: '//server/otcs/cs/api/v2/nodes/9999/nodes?fields=properties&fields=versions%7Bowner_id%7D.element(0)&expand=properties%7Bnode%7D&limit=30&page=1',
        status: 404,
        responseText: {
          success: false,
          data: 'Invalid node id'
      ...
      mocks.push(mockjax({
        url: '//server/otcs/cs/api/v2/nodes/815/nodes?fields=properties&fields=versions%7Bowner_id%7D.element(0)&expand=properties%7Bnode%7D&limit=30&page=1',
        responseText: {
          "collection": {
            "paging": {
              "limit": 30,
      ...
      mocks.push(mockjax({
        url: '//server/otcs/cs/api/v2/nodes/1706/nodes?fields=properties&fields=versions%7Bowner_id%7D.element(0)&expand=properties%7Bnode%7D&limit=30&page=1',
        responseText: {
          "collection": {
            "paging": {
              "limit": 30,
      ...
      mocks.push(mockjax({
        url: '//server/otcs/cs/api/v2/nodes/1705/nodes?fields=properties&fields=versions%7Bowner_id%7D.element(0)&expand=properties%7Bnode%7D&limit=30&page=1',
        responseText: {
          "collection": {
            "paging": {
              "limit": 30,
