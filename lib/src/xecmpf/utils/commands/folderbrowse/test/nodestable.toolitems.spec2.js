  ...
  describe('FolderBrowserWidget', function () {
    ...
    it('has displayed search results view',
        function (done) {
          ...
          folderBrowser.folderView.$el.find(".csui-search-button .csui-header-search-icon").click();
          setTimeout(function () {
    ...
    it('has displayed nodes table view',
        function (done) {
          folderBrowser.folderView.$el.find(".cs-search-results-wrapper .arrow_back").click();
          setTimeout(function () {
